...
use_filters = 1;
if use_filters
    data = load("C:\Users\giann\OneDrive\Desktop\ECG HG paper\results_data\single_participant_quality_dataset_MA.mat");
else
    data = load("C:\Users\giann\OneDrive\Desktop\ECG HG paper\results_data\single_participant_quality_dataset_no_filters.mat");
end
...
%     end
    ...
    if ~strcmp(fieldd,['p',char(no_AgCl)])
        AgCl = p_struct.AgCl;
    end
    ...
    if ~strcmp(fieldd,['p',char(no_AgCl)])
        ...
        profiling_struct.(fieldd).AgCl.ch1 = NaN;
        profiling_struct.(fieldd).AgCl.ch2 = NaN;
        profiling_struct.(fieldd).AgCl.ch3 = NaN;
    end
    if calcMetrics
...
if use_filters
    save('C:\Users\giann\OneDrive\Desktop\ECG HG paper\results_data\single_participant_heartbeat_profiles_MA.mat','profiling_struct')
else
    save('C:\Users\giann\OneDrive\Desktop\ECG HG paper\results_data\single_participant_heartbeat_profiles_no_filters.mat','profiling_struct')
end
